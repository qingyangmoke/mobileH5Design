 ...
 * 判断某个dom元素是否可视区域
 * @author 清扬陌客
 * @param {HTMLElement|JQuery} 要判断的dom元素 支持jQuery对象
 * @param {Boolean} 是否严格要求全部在viewport true 必须全部在viewport里才算是在viewport中 false 有一小部分在viewport就算是在
 * @param {number} 允许多少误差 正数
